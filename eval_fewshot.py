...
parser.add_argument('--rank', type=int, default=0, help='the rank for current GPU')
...
pretrained_dict = {key.replace("module.encoder.", ""): value for key, value in pretrained_dict.items()}
...
print("dataset: %s, k_way: %d, m_shot: %d" % (args.dataset, args.k_way, args.m_shot))
