...
from models.mlp import  Projector
...
class DGCNN_cls(nn.Module):
    def __init__(self, args, num_cls=-1):
    ...
    def forward(self, x):
        ...
        x = F.adaptive_max_pool1d(x, 1).view(batch_size, -1)   # output x1: (batch_size, feature_dim=args.emb_dims)
...
class DGCNN_partseg(nn.Module):
    ...
    def forward(self, x, l=None):
        ...
        t = self.transform_net(x0)          # (batch_size, 3, 3) 语义分割去除这个即可
        ...
        if self.pretrain:
            ...
            x = x.repeat(1, 1, N)  # (batch_size, 1088, num_points)
