...
class PointNet_cls(nn.Module):
    def __init__(self, args, global_feat=True, feature_transform=False):
        ...
        self.conv3 = nn.Conv1d(128, self.emb_dims, kernel_size=1, bias=False)
...
class PointNet_partseg(nn.Module):
    def __init__(self, args, seg_num_all=50, pretrain=True):
        ...
        self.conv5 = torch.nn.Conv1d(512, args.emb_dims, 1, bias=False)
        ...
        self.convs1 = torch.nn.Conv1d(2896, 256, 1, bias=False)
