...
class PlyData(object):
    ...
    def read(stream):
        """
        Read PLY dataset from a readable file-like object or filename.
    ...
    def write(self, stream):
        """
        Write PLY dataset to a writeable file-like object or filename.
...
class PlyElement(object):
    ...
    def dtype(self, byte_order='='):
        ...
        dataset.  (If there are no list properties, and the PLY format is
    ...
    def _read(self, stream, text, byte_order):
        """
        Read the actual dataset from a PLY file.
        ...
        if text:
            ...
            if self._have_list:
                ...
                # There are no list properties, so loading the dataset is
    ...
    def _write(self, stream, text, byte_order):
        """
        Write the dataset to a PLY file.
...
class PlyProperty(object):
    ...
    """
    PLY property description.  This class is pure metadata; the dataset
    ...
    def _read_bin(self, stream, byte_order):
        """
        Read dataset from a binary stream.  Raise StopIteration if the
    ...
    def _write_bin(self, data, stream, byte_order):
        """
        Write dataset to a binary stream.
...
class PlyListProperty(PlyProperty):
    ...
    def _to_fields(self, data):
        ...
        list dataset (length followed by actual dataset).
