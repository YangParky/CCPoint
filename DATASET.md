...
```
Download:
Please download the ShapeNet55 pointcloud data from [Point-BERT repo](https://github.com/lulutang0608/Point-BERT/blob/49e2c7407d351ce8fe65764bbddd5d9c0e0a4c52/DATASET.md), 
and download the ShapeNet55 image data from [Our Google Drive](https://drive.google.com/drive/folders/1ScKJpZbHh7VOqv0BebcRhcDc-JpJxJLd?usp=share_link). 
Specially, the image data is different from the pointcloud data in some samples, 
